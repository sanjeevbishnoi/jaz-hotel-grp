...
class _Offers extends State<Offers> {
  ...
  showOfferWidget(int index) {
    ...
    return InkWell(
      ...
      child:  MemberListScreen(onBack: widget.onBack)
      // Container(
      ...
      //         fit: BoxFit.cover,
      //         height:
      //             overAllHeight * (AppUtility().isTablet(context) ? 0.4242 : 0.35),
      //         width: overAllWidth,
      //       ),
      //       Container(
      //         padding: EdgeInsets
      ...
      //         child: Text(Strings.bookNowOffer,
  ...
  //FirebaseEvents().viewPromotionEvent(time_Slot, hotelName, locationID, promoCode, promoName)
  ...
  searchOnClick(String promoCode, String type) async {
    ...
    ProductsQueryArguments args = SearchService().getProductQueryArguments(
        startDate, endDate, "", "", roomRef, roomRefType, "");
