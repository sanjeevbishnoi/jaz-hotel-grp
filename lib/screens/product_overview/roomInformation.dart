...
class _RoomInformationState extends State<RoomInformation> {
      ...
      body: Container(
          ...
          child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                var roomPrice = rooms[index].price!.amount.toInt().toString();
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  checkAvailablity(
                                      ...
                                      rooms[index],
                                      rooms[index].promoCode != null
                                          ? rooms[index].promoCode!.toString()
                                          : '');
                                },
                                child: Text(
  ...
  Future<void> checkAvailablity(
      String selectedRoomName,
      String roomTypeCode,
      String roomRatePlanCode,
      String price,
      String ratePlanCurrencyCode,
      DetailOfferDataMixin$Rooms$Room offer,
